...
pub fn optimize(
    ...
    gc_snapshots(db_path, new_manifest.active_snapshot_gen, new_manifest.prev_snapshot_gen)?;
...
pub fn collect_graph_data(
    ...
    for (node_id, node_delta) in &delta.created_nodes {
        ...
        let node_labels = node_delta.labels.as_ref()
...
mod tests {
    ...
    fn test_parse_snapshot_gen() {
        ...
        assert_eq!(parse_snapshot_gen("snapshot_1234567890.ray"), Some(1234567890));
