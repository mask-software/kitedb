...
impl<T> VersionedRecord<T> {
    ...
    pub fn with_prev(data: T, txid: TxId, commit_ts: Timestamp, prev: Box<VersionedRecord<T>>) -> Self {
        Self {
            data,
            txid,
            commit_ts,
    ...
    pub fn deletion(data: T, txid: TxId, commit_ts: Timestamp, prev: Option<Box<VersionedRecord<T>>>) -> Self {
        Self {
            data,
            txid,
            commit_ts,
